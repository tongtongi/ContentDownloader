...
/**
 * Unit tests for the implementation of [DeleteContentUseCase]
 */
@ExperimentalCoroutinesApi
class DeleteContentUseCaseTest {
    private val contentRepository: ContentRepository = mock()

    private val useCase = DeleteContentUseCase(contentRepository)
    ...
    @Test
    fun `delete content from repository when usecase is invoked`() {
        runBlocking {
            useCase(content)
        }
